...
<body>
	<form action="../clater/report_clater.php" target="_blank" method="post">
	<div class="container">
		<div class="row">
		<div class="col-sm-12 alto-bajo"></div>
			<div class="col-sm-12 alto-bajo">
				<h3>Informe Control Posterior</h3>
			</div>
			...
			<div class="col-sm-12 alto-bajo"></div>
			<div class="col-sm-12">
				<button name="Submit" type="submit" value="subtmi" class="btn btn-primary col-sm-3">Generar Informe</button>
			</div>
		</div>
	</div>
	</form>
