...
<form name="frProfesionales" id="frProfesionales" method="POST">
  ...
  <h5>TRAMITADOR</h5>
    ...
    <div class="col-lg-12 input-group opcion0" id="opcion0" hidden="">
      ...
      <div class="col-lg-5 input-group">
        <label for="tajeta" class="col-form-label col-lg-3 " style="padding-right: 0px;">TARJETA</label>
        <input type="text" class="form-control col-lg-8"  id="tajeta" name="tajeta" placeholder="Numeros y Letras" onChange="letras(this)" >
      </div>
      <div class="col-lg-5  input-group">
        <label for="profesion" class="col-form-label col-lg-4 ">PROFESION</label>
