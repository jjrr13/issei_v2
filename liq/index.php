          ...
          <div class="card card-danger">
            ...
            <table width="364" border="0">
              <tr>
                ...
                <td colspan="3" class="submenubgd">
                  <input name="reloteos" type="text" id="reloteos" onkeyup="xajax_liquidacion(xajax.getFormValues('form1'));return acceptNum(event);" value="<?= $_POST['reloteos']; ?>" size="15" >M<sup>2</sup>
              ...
              <tr>
                ...
                <td colspan="3" class="submenubgd">
                  <input name="movimiento_tierras" type="text" id="movimiento_tierras" onkeyup="xajax_liquidacion(xajax.getFormValues('form1'));return acceptNum(event);" value="<?= $_POST['movimiento_tierras']; ?>" size="15" >M<sup>3</sup>
              ...
              <tr>
                ...
                <td width="33" class="submenubgd">
                  V.I.S
                </td>
                <td width="78" class="submenubgd">
              ...
              <tr>
                <td class="submenubgd">
                  Modificacion Planos Urb. 
                </td>
                <td colspan="3">
                  <div id="d_subdivision_total">
              ...
              <tr>
                ...
                <td colspan="3"><span class="submenubgd">
                  <input name="apro" type="text" id="apro" onkeyup="xajax_liquidacion(xajax.getFormValues('form1'));return acceptNum(event);" value="<?= $_POST['apro']; ?>" size="15"/>M<sup>2</sup>  
