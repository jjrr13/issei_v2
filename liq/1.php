<?php 
  ...
  function liquidacion($formulario){
      ...
      // mysqli_select_db($database_cx, $cx);
                ...
                <div class="row form-group">
                  <div class="col-lg-12  input-group">
                    ...
                    <div class="col-lg-6  input-group">
                      ...
                      <select name="estrato_1" onChange="xajax_liquidacion(xajax.getFormValues('form1'))">
                        <option value="0" <?php if($_POST['estrato_1'] == 0) echo "selected"; ?> >Vivienda</option>
                        <option value="1" <?php if($_POST['estrato_1'] == 1) echo "selected"; ?> >Estrato 1</option>
                        <option value="2" <?php if($_POST['estrato_1'] == 2) echo "selected"; ?> >Estrato 2</option>
                        <option value="3" <?php if($_POST['estrato_1'] == 3) echo "selected"; ?> >Estrato 3</option>
                        <option value="4" <?php if($_POST['estrato_1'] == 4) echo "selected"; ?> >Estrato 4</option>
                        <option value="5" <?php if($_POST['estrato_1'] == 5) echo "selected"; ?> >Estrato 5</option>
                        <option value="6" <?php if($_POST['estrato_1'] == 6) echo "selected"; ?> >Estrato 6</option>
                      </select>                    
                    </div>
                  </div>
                  ...
                  <div class="borde input-group col-lg-11">
                    ...
                    <div class="col-lg-12  input-group">
                      ...
                      <div class="col-lg-2 form-check">
                        <input name="vivienda_1" type="text" id="vivienda_1" value="<?php $_POST['vivienda_1']; ?>" size="13" onKeyPress="document.form1.modificado.value='vivienda_1';" readonly  >
                  ...
                  <div class="borde input-group col-lg-11">
                    ...
                    <div class="col-lg-12  input-group">
                      ...
                      <div class="col-lg-3 input-group">
                        <input name="vivienda_vis_cant_10" type="text" id="vivienda_vis_cant_10" onkeyup="xajax_liquidacion(xajax.getFormValues('form1'));return acceptNum(event);" value="<?php $_POST['vivienda_vis_cant_10']; ?>" size="15" >
                        <label>U/d</label>                      
                      </div>
                      <div class="col-lg-2  input-group"></div>
                      <div class="col-lg-2 form-check">
                        <input name="vivienda_vis_10" type="text" id="vivienda_vis_10" value="<?php $_POST['vivienda_vis_10']; ?>" size="13" onkeypress="document.form1.modificado.value='vivienda_vis_10';" readonly="readonly" >
                        <input name="cero_vivienda_vis_10" type="checkbox" id="cero_vivienda_vis_10" value="1" onclick="xajax_liquidacion(xajax.getFormValues('form1'))" >
                        <input name="vivienda_vis_total_10" type="hidden" id="vivienda_vis_total_10" value="<?php $_POST['vivienda_vis_total_10']; ?>" >                  
                      </div>
                    </div>
                    <div class="form-group col-lg-12 "></div>
                    <div class="col-lg-12  input-group">
                  ...
                  <div class="col-lg-12  input-group">
                    ...
                    <div class="col-lg-5  input-group">
                      <input name="estampillas" type="text" id="estampillas" value="<? if(empty($_POST['estampillas'])){echo '4500';}else{echo $_POST['estampillas'];} ?>" size="17" onChange="xajax_liquidacion(xajax.getFormValues('form1'))" onKeyUp="xajax_liquidacion(xajax.getFormValues('form1'))" >
                    </div>
                  </div>
                  <div class="form-group col-lg-12 "></div>
                  <div class="col-lg-12  input-group">
